...
export default function Notifications({ onClose, show, setNewNotifications }: NotificationsProps) {
  ...
  return (
    <div
      className={`${show ? "block" : "hidden"}  z-10 w-full md:w-[460px] right-0 left-0 md:left-auto md:right-[20px] lg:right-[190px] h-[400px]  md:h-[420px] rounded-[8px]  bg-[#FFFFFF] fixed md:absolute top-[68px] md:top-[0px] border border-[#E1E4EA] shadow-2xl`}
